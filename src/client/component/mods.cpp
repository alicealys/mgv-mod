...
namespace mods
{
    ...
    namespace
    {
        ...
        void autload_mods(const std::string& path, bool pre_load)
        {
        ...
        void fs_module_init_stub()
        {
            ...
            autload_mods("mods/autoload", false);
