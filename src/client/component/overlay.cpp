...
namespace overlay
{
	namespace
	{
		...
		void draw_fps_ping(game::fox::gr::dg::plugins::Draw2DRenderer* instance)
		{
			...
			{
				offset_x -= fps_width;
				renderer::draw_text(instance, L"fps:", font_size, offset_x, text_y, color_text, color_outline);
			...
			if (ping_text != nullptr)
			{
				...
				renderer::draw_text(instance, L"ping:", font_size, offset_x, text_y, color_text, color_outline);
